                        ...
                        <div class="col-sm-12">
                            <h4 class="page-title">INSTANT CUBES</h4>
                            	<ol class="breadcrumb">
                            		...
                            		<li class="active">Edit Gemscool Cash</li>
                            	</ol>
                        </div>
                    </div>
                    <!-- Page Title End -->
...
$queryb = mysql_query("SELECT * FROM gemscool WHERE code = '$edit_id'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="white-box bg-warning">
                                ...
                                <hr>
                                <!-- start content -->
		                  <form class="form-horizontal" method="POST" action="?admin=gemscool-cash">
...
<? } else {
	$send = mysql_query("INSERT INTO gemscool(nama, code, jumlah, harga) VALUES ('$add_nama','$add_code','$add_jumlah','$add_harga')");
...
$cekdata = mysql_query("SELECT * FROM gemscool WHERE code = '$add_id'");
...
<div class="alert alert-danger"> <strong>Error: </strong> Cash tidak ditemukan. </div>
<? } else {
$send = mysql_query("DELETE FROM gemscool WHERE code = '$add_id'");

if ($send) { ?>
<div class="alert alert-info">
<font color="black">
<strong>Success: </strong> Delete Cash berhasil!<br />
...
// mencari data di database
$cekdata = mysql_query("SELECT * FROM gemscool WHERE code = '$add_code'");
$sdata = mysql_fetch_array($cekdata);
$scount = mysql_num_rows($cekdata);
...
<div class="alert alert-danger"> <strong>Error: </strong> Masih ada data yang kosong. </div>
<? } else {
	$send = mysql_query("UPDATE gemscool SET nama = '$add_nama' WHERE code = '$add_code'");
	$send = mysql_query("UPDATE gemscool SET code = '$add_code' WHERE code = '$add_code'");
	$send = mysql_query("UPDATE gemscool SET jumlah = '$add_jumlah' WHERE code = '$add_code'");
	$send = mysql_query("UPDATE gemscool SET harga = '$add_harga' WHERE code = '$add_code'");
...
<? } } } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="white-box">
                                <h4><i class="fa fa-gear"></i> Edit Gemscool Cash</h4>
                                <hr>
                                <!-- start content -->
                                <div class="row">
                                	<div class="col-md-6">
...
<?php
$querya = "SELECT * FROM gemscool ORDER BY code ASC";
...
<? $noa++; } ?>
			              ...
			              <table id="myTable" class="table table-striped" style="font-size: 10px;">
			                ...
			                <tbody>
<?php
 $queryu = "SELECT * FROM gemscool ORDER BY code ASC";
...
?>
			                  <tr>
			                    ...
			                    <td><a class="btn btn-sm btn-block btn-success waves-effect waves-light" href="?admin=gemscool-cash&id=<?php echo $code; ?>"> Edit</a></td>
			                  </tr>
<?
$no++;
} ?>
