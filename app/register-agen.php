...
echo "Saldo tidak mencukupi";
 ...
 $sql= mysql_query("INSERT INTO user(username, password, balance, level, register, balance_used, Status) VALUES ('$username','$password','20000','agen','$uplink','0','aktif')");

 //Inserted

 if($sql){

 echo "Register Agen SMedia Panel Done
------------------------------------
Nama = $nama
Username = $username
Password = $password
