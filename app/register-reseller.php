...
echo "Saldo tidak mencukupi";
 ...
 $sql= mysql_query("INSERT INTO user(username, password, balance, level, register, balance_used, Status) VALUES ('$username','$password','30000','reseller','$uplink','0','aktif')");

 //Inserted

 if($sql){

 echo "Register Reseller SMedia Panel Done
------------------------------------
Nama = $nama
Username = $username
Password = $password
