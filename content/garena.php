                    ...
                    <div class="row title_bg">
                        <div class="col-sm-12">
                            <h4 class="page-title">INSTANT CUBES</h4>
                            	<ol class="breadcrumb">
                            		<li><a href="#">Home</a></li>
                            		<li class="active">Shell Garena</li>
                            	</ol>
                        </div>
                    </div>
                    <!-- Page Title End -->
...
$dataservice = mysql_query("SELECT * FROM garena WHERE jumlah='$quantity'");
...
$order_id = rand(10000000000000,100000000000000);
	$del = mysql_query("DELETE FROM `garena` WHERE `code`='$code'");
	...
	$send = mysql_query("INSERT INTO order_history(order_id, provider, buyer, service, link, quantity, price, status, date, time) VALUES ('$order_id','GARENA','$username','$namab','Garena Code : $code','$quantity','$price','Success','$date','$time')");
...
<? } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="white-box">
                                <h4><i class="fa fa-cart-plus"></i> Shell Garena</h4>
                                <hr>
                                <!-- start content -->
		                  <form class="form-horizontal" method="POST">
		                    <div class="form-group">
		                      ...
		                      <div class="col-md-12">
                                                            <?php
                                                            $i = 1;
                                                            $g1 = mysql_query("SELECT * FROM garena");
