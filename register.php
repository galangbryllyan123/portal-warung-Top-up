...
<head>
    <meta charset="UTF-8">
        ...
        <title>Instant Cubes - Daftar</title>
            ...
            <div class="white-box">
                <form class="form-horizontal m-t-20" method="POST">
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <h3>Daftar Akun <b>INSTANT CUBES</b> :)</h3>
...
if($jumlah !== 0) { // user sdh terdaftar ?>
<div class="alert alert-danger"> <strong>Error!</strong> Username sudah terdaftar. </div>
<script>
swal("Error!", "Username sudah terdaftar.", "error");
</script>
...
<? } else {
   if($pass <> $repass) { // pass salah ?>
<div class="alert alert-danger"> <strong>Error!</strong> Password yang dimasukkan tidak sama. </div>
<script>
swal("Error!", "Password yang dimasukkan tidak sama.", "error");
</script>
<? } else {
$send = mysql_query("INSERT INTO user(username, password, balance, level, register, balance_used, status) VALUES ('$username','$pass','0','Member','Server','0','Aktif')");
if($send){
	...
	header('location:/');
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" required="" placeholder="Masukan Ulang Password" name="repassword">
                        </div>
                    ...
                    <div class="form-group m-t-30 m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Sudah Punya Akun? <a href="login.php" class="text-primary m-l-5"><b>Login</b></a><br />
