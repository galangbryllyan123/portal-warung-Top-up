...
<? } else if ($jumlah < 250) { ?>
<div class="alert alert-danger">
Gagal : Minimal 250 Like.
</div>
<? } else if ($jumlah > 1000) { ?>
<div class="alert alert-danger">
Gagal : Maksimal 1000 Like.
</div>
<? } else if ($harga < '700') { 
...
$tanggal = date("Y-m-d");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harga WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO history VALUES('','#$no','$username','$jumlah Like Facebook Fanspage $server','$harga','Sukses','Link : $link','$tanggal')");
if($simpan) { 
...
Tanggal : $tanggal<br />
Pembeli : $nama<br />
Barang : $jumlah Facebook FansPage Like $server<br />
Link : $link<br />
Harga : $harga<br />
Status : Sukses<br />
