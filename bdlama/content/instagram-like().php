...
$tanggal = date("Y-m-d");
	  ...
	  $simpan = mysql_query("UPDATE user SET saldo=saldo-$harga WHERE username = '$username'");
          $simpan = mysql_query("INSERT INTO history VALUES('','#$no','$username','$jumlah Like Instagram $server','$harga','Sukses','Link : $link','$tanggal')");
if($simpan) { 
...
curl_setopt($ch, CURLOPT_POSTFIELDS,
          "apikey=$apikey&target=$link&id=2&jumlah=$jumlah&server=$service");
...
echo "==== Instagram Like ====<br />
Order  ID : #$no<br />
Tanggal : $tanggal<br />
Pembeli : $nama<br />
Start : $result['start']<br />
Barang : $jumlah Instagram Like $server<br />
Username/Link : $link<br />
Harga : $harga<br />
Status : Sukses<br />
==== Instagram Like ===="; // Ubah jika berhasil akan menampilkan kode seperti apa
