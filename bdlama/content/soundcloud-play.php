...
?>
                                <div class="panel panel-color panel-primary">
                                    <div class="panel-heading"> 
                                        <h3 class="panel-title">SoundCloud Play</h3> 
                                    </div> 
...
<option value="24">SoundCloud Plays (INSTANT)</option>
                                                </select>
                                            </div>
                                        </div>
<br />         
...
<i><pre>
Server 1 : 1.200 / 100 Play [ Min : 100 - Max : 3000 ]
...
post();
	...
	var harga = $('#harga').val();
	$.ajax({
		url	: 'content/soundcloud-play().php',
